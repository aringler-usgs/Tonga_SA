...
im = ax.scatter(lons, lats, c=rrats, s = 100., transform=ccrs.Geodetic(), zorder=3, alpha=0.5, marker='o', vmin=0, vmax=30, edgecolor='k')
...
cbar.set_label('Radial Ratio Hunga Tonga (nm/s/Pa)') 
...
# # plt.ylim(0.,100.)
# # #plt.tight_layout()
plt.savefig('Figure102.png', format='PNG', dpi=400)
plt.savefig('Figure102.pdf', format='PDF', dpi=400)
# f.close()
