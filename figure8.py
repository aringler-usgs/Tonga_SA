...
im = ax.scatter(lons, lats, c=therats, s = 100., transform=ccrs.Geodetic(), zorder=3, alpha=0.5, marker='o', vmin=0, vmax=100, edgecolor='k')
...
cbar.set_label('Deviation from Crust 1.0 (%)') 
